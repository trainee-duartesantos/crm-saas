...
<template>
    <div class="mx-auto max-w-6xl space-y-6">
        <Heading title="Activities" description="Tasks, calls and follow-ups" />
        ...
        <div class="rounded-lg border border-red-300 bg-red-50 p-4">
            ...
            <div v-else class="space-y-2">
                ...
                >
                    ...
                    <div class="text-xs text-gray-500">Due {{ a.due_at }}</div>
                </div>
            </div>
        </div>
    ...
    <div class="rounded-lg border bg-white p-5">
        ...
        <div class="grid grid-cols-1 gap-3 md:grid-cols-6">
            ...
            <div class="md:col-span-3">
                <label class="text-xs text-gray-500">Person (optional)</label>
                <select
    ...
    <div class="rounded-lg border bg-white p-5">
        ...
        <div v-else class="space-y-3">
            <div v-for="a in pending" :key="a.id" class="rounded border p-4">
